...
const SearchBar: React.FC<SearchBarProps> = ({ 
  ...
  return (
    <div className="sticky top-0 z-30" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
      <div className="px-4 pb-3 pt-2 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border-b border-neutral-200/50 dark:border-neutral-800/50 relative z-20">
      ...
      {isFilterOpen && (
        <>
          {/* Backdrop to close filter on click outside */}
          <div 
            className="fixed inset-0 z-10 bg-black/5 backdrop-blur-[1px] transition-opacity" 
            onClick={closeFilterPanel}
            style={{ top: 'calc(3.5rem + env(safe-area-inset-top))' }} // Header height offset approximate
          ></div>
          
          <div className="absolute top-full left-0 right-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-xl border-b border-neutral-200 dark:border-neutral-700 p-5 shadow-xl animate-slide-down rounded-b-3xl mx-2 z-20">
